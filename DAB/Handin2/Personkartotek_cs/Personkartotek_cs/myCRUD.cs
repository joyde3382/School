...
//    class myCRUD
//    {
//        public void Create(PersonDBContext db, Person person)
//        {
...
//            person = new Person { fullName = "Bodil Storm", personType = Friend };
...
//        {
//            List<Person> people = db.persons.ToList<Person>();

//            Person Person = people.FirstOrDefault(m => m.fullName == personName);
...
//            List<Person> person = db.persons.ToList<Person>();

//            Person personsNote = person.FirstOrDefault(m => m.fullName == personName);
...
//            Person person = db.persons.FirstOrDefault(p => p.fullName == personName);
