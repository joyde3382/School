namespace Personkartotek_cs.Migrations
{
    ...
    public partial class help : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        personNote_noteId = c.Int(),
                        personType_personTypeId = c.Int(),
                    })
                .PrimaryKey(t => t.personId)
                .ForeignKey("dbo.Notes", t => t.personNote_noteId)
                .ForeignKey("dbo.PersonTypes", t => t.personType_personTypeId)
                .Index(t => t.personNote_noteId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Person_Class", "personNote_noteId", "dbo.Notes");
            ...
            DropIndex("dbo.Person_Class", new[] { "personNote_noteId" });
