...
-- zipCode         :  
-- cityName        :  
-- cityName1       :  (references City.cityName)
-- zipCode1        :  (references City.zipCode)
...
CREATE TABLE Address (
    ...
    zipCode        CHAR(1) NOT NULL,
    cityName       CHAR(1) NOT NULL,
    cityName1      CHAR(1) NOT NULL,
    zipCode1       CHAR(1) NOT NULL,
    fullName       CHAR NOT NULL,
CONSTRAINT pk_Address PRIMARY KEY CLUSTERED (addressType,streetAddress,countryRegion,zipCode,cityName),
CONSTRAINT fk_Address2 FOREIGN KEY (cityName1,zipCode1)
...
CREATE TABLE GenericType (
    ...
    zipCode        CHAR(1) NULL,
    cityName       CHAR(1) NULL,
    company        CHAR NULL,
    phoneNumber    BIGINT NULL,
CONSTRAINT pk_GenericType PRIMARY KEY CLUSTERED (type),
CONSTRAINT fk_GenericType FOREIGN KEY (addressType,streetAddress,countryRegion,zipCode,cityName)
